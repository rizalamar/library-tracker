...
public class MyBookService {
    ...
    private BookResponse mapToBookResponse(Book book, BookResponse enriched){
        return BookResponse.builder()
                ...
                .description(enriched != null ? enriched.description() : null)
                .physicalFormat(enriched != null ? enriched.physicalFormat() : null)
                .languages(enriched != null ? enriched.languages() : List.of())
                .publishPlaces(enriched != null ? enriched.publishPlaces() : List.of())
