...
public class BookController {
    ...
    @GetMapping("/{bookId}")
    public ResponseEntity<WebResponse<BookResponse>> getBookById(@PathVariable("bookId") UUID id){
    ...
    public ResponseEntity<WebResponse<BookResponse>> createBook(@Valid @RequestBody BookRequest request){
    ...
    @PutMapping("/{bookId}")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<WebResponse<BookResponse>> updateBook(
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<WebResponse<String>> deleteBook(@PathVariable("bookId") UUID id){
